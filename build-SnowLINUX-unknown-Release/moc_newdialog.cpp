...
static const char qt_meta_stringdata_NewDialog[] = {
    ...
    "slotChangeURL(QString)\0slotChangePathS(QString)\0"
    "slotChangeTN(int)\0"
};
...
void NewDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotChangeURL((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->slotChangePathS((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->slotChangeTN((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
